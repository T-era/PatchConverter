...
import jp.gr.java_conf.t_era.patch.patterning.SandwichPattern;

public class NewFilePattern implements ConverterFactory {
	private static final BytePattern[] SVN_PATTERN
		= new BytePattern[] {
			...
			, new PrefixPattern("===================================================================".getBytes()
					, "")
			, new SandwichPattern("--- ".getBytes(), "0)".getBytes()
